...
const ProductDetailsPage = () => {
  ...
  //   if (authUser) {
  //     try {
  //       // Create a reference to the "user-cart" collection under the user's profile
  //       const cartRef = collection(db, `profile-${authUser.uid}`, "user-cart");
  ...
  //           // Update the quantity of the existing cart item
  //           await setDoc(existingCartDocRef, { quantity: newQuantity }, { merge: true });
